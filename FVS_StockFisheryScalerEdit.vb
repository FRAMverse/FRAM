...
SkipSFSSave:
   ...
   End Sub
    ...
    Private Sub BtnShowScalers_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnShowScalers.Click
        Me.Visible = False
        FVS_ActiveRateScaler.ShowDialog()
        Me.BringToFront()
    End Sub
End Class