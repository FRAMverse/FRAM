         ...
         '- Compute Fishery/Time-Step Mortality for a Stock
            For Fish As Integer = 1 To NumFish
                ...
                Else
                    ...
                    MSFEncounters(Stk, Age, Fish, TStep) = Cohort(Stk, Age, TerminalType, TStep) * BaseExploitationRate(Stk, Age, Fish, TStep) * MSFFisheryScaler(Fish, TStep) * StockFishRateScalers(Stk, Fish, TStep)
